...
NewParser::Instruction::Instruction() {

}

NewParser::Instruction NewParser::Instruction::make(OpCodes opCode) {
	NewParser::Instruction inst;
	inst.opCode = opCode;
	return inst;
}

NewParser::Instruction NewParser::Instruction::makeWithInt(OpCodes opCode, int value) {
	NewParser::Instruction inst;
	inst.intValue = value;
	inst.opCode = opCode;
	return inst;
...
NewParser::Instruction NewParser::Instruction::makeWithFloat(OpCodes opCode, float value) {
	NewParser::Instruction inst;
...
NewParser::Instruction NewParser::Instruction::makeWithChar(OpCodes opCode, char value) {
	NewParser::Instruction inst;
...
NewParser::Instruction NewParser::Instruction::makeWithStr(OpCodes opCode, std::string value) {
	NewParser::Instruction inst;
	inst.strValue = value;
	inst.opCode = opCode;
	return inst;
...
NewParser::Instruction NewParser::Instruction::makeCall(std::string funcName, std::vector<std::string> parameters) {
	NewParser::Instruction inst;
...
NewParser::Instruction NewParser::Instruction::makeCallInstance(std::string structType, std::string funcName, std::vector<std::string> parameters) {
	NewParser::Instruction inst;
...
NewParser::Instruction NewParser::Instruction::makeNewObject(std::string structType, std::vector<std::string> parameters) {
	NewParser::Instruction inst;
	inst.calledStructType = structType;
...
NewParser::Function::Function()
	: isMemberFunction(false), isExternal(false) {

}

void NewParser::Function::setNumLocals(int num) {
	localTypes.resize(num);
}

std::size_t NewParser::Function::numLocals() const {
...
namespace {
	...
	void parseFunctionDef(const std::vector<std::string>& tokens, std::size_t& tokenIndex, NewParser::Function* func) {
...
std::vector<std::string> NewParser::tokenize(std::istream& stream) {
...
void NewParser::parseTokens(const std::vector<std::string>& tokens, NewParser::Assembly& assembly) {
	bool isFunc = false;
